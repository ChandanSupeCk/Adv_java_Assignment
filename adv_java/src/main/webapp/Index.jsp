...
<html>
    ...
    <body>
        <form action="CalcSer" method="post">
            ...
            <br><br>
            <input type="submit" name="btnsubmit" value="5" />
            <input type="submit" name="btnsubmit" value="6" />
            <input type="submit" name="btnsubmit" value="7" />
            <input type="submit" name="btnsubmit" value="8" />
            <br><br>
            <input type="submit" name="btnsubmit" value="9" />
            <input type="submit" name="btnsubmit" value="0" />
            <br><br>
